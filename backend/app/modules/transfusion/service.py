...
_APP_DIR = Path(__file__).resolve().parent.parent.parent  # backend/app/
_MODEL_PATH = _APP_DIR / "thalassemia_units_xgboost.pkl"
_COLS_PATH = _APP_DIR / "thalassemia_feature_columns.pkl"
